...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for letter in word:
            if letter not in hand.keys() or hand.get(letter) < wordDict.get(letter):
                return False   
        return True
    else:
        return False
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score += wordScore
                print("{0}' earned '{1}' points. Total: '{2}' points".format(userInput, wordScore, score))
                print()
                # Update the hand 
    ...
    while True:
        ...
        if userInput == 'n':
            ...
            if bool(hand):
                ...
                print("You must first start a new game")
        elif userInput == 'e':
            break
        else:
